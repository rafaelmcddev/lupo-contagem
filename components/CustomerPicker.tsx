      ...
      {showCreateForm && (
        ...
        <div className="flex flex-col gap-3 rounded-xl border border-gray-200 p-4" onKeyDown={handleCreateFormKeyDown}>
          <input
            ...
            className="w-full rounded-lg border border-gray-300 px-3 py-2.5 text-base placeholder:text-sm focus:border-accent focus:ring-2 focus:ring-accent/40 focus:outline-none"
          />
          <PhoneInput

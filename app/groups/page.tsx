    ...
    <main className="mx-auto max-w-2xl p-4 sm:p-8">
      ...
      <form onSubmit={addGroup} className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center">
        <input
          ...
          placeholder="Prefixo"
          className="rounded-lg border border-gray-300 px-3 py-3 text-base placeholder:text-sm focus:border-accent focus:ring-2 focus:ring-accent/40 focus:outline-none sm:w-40"
        />
        <input
          value={name}
